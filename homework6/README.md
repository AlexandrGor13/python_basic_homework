...
#### Выполнение:
1. Создана база данных на основе PostgreSQL
2. Созданы таблицы users и posts
3. Создайте асинхронные функции для выполнения запросов к данным ресурсам https://jsonplaceholder.typicode.com/
4. Созданы функции для добавления базу данных информации полученной из ресурса
